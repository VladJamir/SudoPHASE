...
sudokusolver : board.o sudokuant.o sudokuantsystem.o parallelsudokuantsystem.o simulatedannealing.o backtracksearch.o solvermain.o 	
	$(CC) -pthread -o sudokusolver obj/board.o obj/sudokuant.o obj/sudokuantsystem.o obj/parallelsudokuantsystem.o obj/simulatedannealing.o obj/backtracksearch.o obj/solvermain.o
